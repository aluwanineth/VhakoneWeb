...
app.controller("myCtrl", function ($scope, $http) {
    ...
    $scope.CreatePersonalDetail = function () {
        ...
        $http({
            method: "post",
            url: "http://localhost:18327/Applicants/CreatePersonalDetail",
            datatype: "json",
    ...
    $scope.EditPersonalDetail = function () {
        ...
        $http({
                method: "post",
                url: "http://localhost:18327/Applicants/EditPersonalDetail",
                datatype: "json",
                data: JSON.stringify($scope.personalDetail)
        }).then(function (response) {
                alert(response.data);
    ...
    $scope.GetAllData = function () {
        $http({
            method: "get",
            url: "http://localhost:18327/Applicants/GetApplicant"
        }).then(function (response) {
